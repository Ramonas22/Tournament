    ...
    public static void main(String[] args) throws ParseException {
      ...
      //  tournamentService.removeTeamFromTournament(session, tournamentList.get(0));
       //tournamentService.pickTeamsForTournament(session, tournamentList.get(0));
        ...
        leaderboardService.createLeaderboard(session);

        //leaderboardService.updateLeaderboard(session, leaderboardService.getLeaderboards(session).get(0));

        leaderboardService.displayLeaderboard(leaderboardService.getLeaderboards(session).get(0));
